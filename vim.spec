...
# Source0-md5:	b2e44dfc96ba032a3b02876998add261
...
%dir %{_datadir}/vim
%doc %{_datadir}/vim/LICENSE
%doc %{_datadir}/vim/README.txt
...
%lang(es) %{_datadir}/vim/tutor/tutor2.es
%lang(fr) %{_datadir}/vim/tutor/tutor1.fr
%lang(fr) %{_datadir}/vim/tutor/tutor2.fr
...
%lang(ru) %{_datadir}/vim/tutor/tutor2.ru
